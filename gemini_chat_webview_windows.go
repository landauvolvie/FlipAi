...
func startGeminiChatControlEndpoint(dataDir string,w webview2.WebView,dev voiceDevTools)(int,io.Closer){
	...
	turn:=func(rw http.ResponseWriter,r *http.Request,prompt string,newChat bool){
		...
		if newChat{var ignored bool;if err:=geminiChatEval(dev,`(()=>{location.href='https://gemini.google.com';return true})()`,false,&ignored);err!=nil{rw.WriteHeader(http.StatusBadGateway);_ = json.NewEncoder(rw).Encode(map[string]any{"ok":false,"detail":err.Error()});return}}
