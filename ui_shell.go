...
var uiSpriteNames = []string{"mail", "send", "agent", "bridge", "server", "power", "shield", "alert", "folder", "folder-up", "refresh"}
...
<div id="icon-sprites" hidden>{{range sprites}}<span id="icon-{{.}}">{{icon .}}</span>{{end}}</div>
<div class="app">
  <aside class="sidebar">
